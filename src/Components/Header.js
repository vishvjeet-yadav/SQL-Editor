...
function Header() {
  ...
  const navColor=['#301934','#592126','#17171f','#083b28','#292929','#691234','#08083b','#ddd'];
  const bodyColor=['#4a3f50','#6b5d5e','#383838','#4e7d79','#565c58','#87596c','#404060','#fff'];
  ...
  <div className="container-fluid mx-2">
    <NavLink id="tab1" className="navbar-brand" to="/">SQL-Editor</NavLink>
